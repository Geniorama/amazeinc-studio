...
export default function MenuPrincipal() {
  return (
    <div className={styles.menuPrincipal}>
      <button className={styles.btnCloseMenu} role={"button"}>
        ...
        <li className={styles.menuPrincipalItem}>
          <Link href="#">
            <a className={styles.menuPrincipalLink}>
              ...
              <div>
                <span className={styles.menuPrincipalTextTop}>HOME</span>
                <span className={styles.menuPrincipalTextBottom}>HOME</span>
              </div>
            </a>
          </Link>
        </li>
